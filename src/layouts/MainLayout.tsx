  ...
  return (
    <div className="min-h-screen lg:h-screen bg-slate-50 text-slate-800 flex flex-col font-sans lg:overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:flex-row lg:overflow-hidden max-w-7xl w-full mx-auto min-h-0">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 min-w-0 lg:h-full lg:overflow-y-auto flex flex-col justify-between gap-6">
          <div className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 min-h-[60vh] shadow-sm flex-1">
            {children}
          </div>
